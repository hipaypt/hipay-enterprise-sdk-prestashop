...
<fieldset>
    ...
    <form action="{$motoLink|escape:'htmlall':'UTF-8'}" method="post" id="hipay_capture_form" class="form-horizontal">
        <input type="hidden" name="cart_id" value="{$cartId|escape:'htmlall':'UTF-8'}"/>
