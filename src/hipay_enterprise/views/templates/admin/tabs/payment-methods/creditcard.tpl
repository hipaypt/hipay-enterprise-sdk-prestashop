                ...
                <div class="panel">
                    <div class="form-group">
                        ...
                        {foreach from=$languages item=language key=id}
                            <div class="col-lg-3 {if $languages|count > 1} translatable-field lang-{$language.iso_code|escape:'htmlall':'UTF-8'} {/if}"
                                 {if $id > 0}style="display: none" {/if}>

                                <div class="row">
                                    <input id="ccDisplayName-{$language.iso_code|escape:'htmlall':'UTF-8'}" type="text"
                                           name="ccDisplayName[{$language.iso_code|escape:'htmlall':'UTF-8'}]"
                                           class="translatable-field lang-{$language.iso_code|escape:'htmlall':'UTF-8'}"
                                            {if isset($config_hipay.payment.global.ccDisplayName[$language.iso_code])}
                                                value="{$config_hipay.payment.global.ccDisplayName[$language.iso_code]|escape:'htmlall':'UTF-8'}"
                                            ...
                                            {else}
                                                value="{$config_hipay.payment.global.ccDisplayName['en']|escape:'htmlall':'UTF-8'}"
                                            {/if}
                                    />
                                </div>
                            ...
                            {if $languages|count > 1}
                                <div class="col-lg-2 translatable-field lang-{$language.iso_code|escape:'htmlall':'UTF-8'} "
                                     {if $id > 0}style="display: none" {/if}>
