 ...
 *}
<div class="panel">
    <script type="text/javascript" src="{$module_dir|escape:'htmlall':'UTF-8'}views/js/bootstrap-multiselect.js"></script>
    <script type="text/javascript" src="{$module_dir|escape:'htmlall':'UTF-8'}views/js/jquery.bootstrap-duallistbox.min.js"></script>
